...
static char *printchoice[3]
={ {"Printout"},
{"standard"},
{"Shareprice Incremented"}
};
         ...
         case F05 : if (pirated() == FALSE)
		{
         ...
         case F07 :
		  ...
		  case 1 :  if (sys.cell.row < 8 || sys.screen == SCREEN2) break;
			    wait();
			    clearrow();
                            showrow(sys.cell.row);

			     if ( sys.cell.row != 22 && sys.cell.row != 37)
		 	     {
			     sys.cell.row += 1;
			     showcell(sys.cell);
			     sys.cell.row = sys.cell.row -1;
		   	     }
                              entercell(sys.cell);
			      break;
		   case 2 : wait();
			 ...
			 case 4: switch( choice(3,resolutionchoice))
				 {
				   ...
				   case 3: numpts = 30; break;
                                    ...
                                    break;
			 case 5: switch( choice(2, printchoice))
