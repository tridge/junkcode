...
int inputstring(int x,int y,char far *string)
{
char ch;
int firstch = TRUE;
char instring[20];
...
long inputlint(int x,int y,long far *defnum,int max)
{
char instring[20];
char ch;
int count;
...
int inputdate(int x,int y,char far *date)
{
char instring[20];
char ch;
int count;
