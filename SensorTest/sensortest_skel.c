#ifndef _SENSORTEST_SKEL_H
#define _SENSORTEST_SKEL_H
/// @file calculator.idl
///
...
__QAIC_SKEL_EXPORT int __QAIC_SKEL(sensortest_skel_invoke)(uint32_t _sc, remote_arg* _pra) __QAIC_SKEL_ATTRIBUTE {
   switch(REMOTE_SCALARS_METHOD(_sc))
   {
      case 0:
      return _skel_method((void*)__QAIC_IMPL(sensortest_start), _sc, _pra);
   }
